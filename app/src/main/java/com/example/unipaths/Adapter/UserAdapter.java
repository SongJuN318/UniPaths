...
import com.example.unipaths.Activities.ScholarshipFragment;
...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.ViewHolder>{
    ...
    public UserAdapter(Context mContext, List<UserHelperClass> mUsers, boolean isfragment){
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
        ...
        final UserHelperClass user = mUsers.get(i);
        ...
        viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (isfragment) {
                    ...
                    ((FragmentActivity) mContext).getSupportFragmentManager().beginTransaction().replace(R.id.fram_container, new ProfileFragment()).commit();
                }else{

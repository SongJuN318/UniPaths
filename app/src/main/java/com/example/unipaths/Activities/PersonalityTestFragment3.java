...
public class PersonalityTestFragment3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_personality_test3, container, false);
        questionContainer = rootView.findViewById(R.id.question_container);
        radioGroupIds = new ArrayList<>();
        questions = getResources().getStringArray(R.array.personality_test_array3);
        ...
        nextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(allAnswered){
                    personalityViewModel.setTrait3(totalScore);
